            ...
            <form method="POST" action="{{ route('convini.register') }}">
                ...
                <div class="c-form__group">
                    ...
                    <div class="c-form__item">
                        <input id="convini_name" type="text" class="c-form__input @error('convini_name') is-invalid @enderror" name="convini_name" value="{{ old('convini_name') }}" required autocomplete="convini_name" autofocus>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('convini.register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="convini_name" type="text" class="form-control @error('convini_name') is-invalid @enderror" name="convini_name" value="{{ old('convini_name') }}" required autocomplete="convini_name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">                                
                                <select id="prefectures" type="text" class="form-control @error('prefectures') is-invalid @enderror" name="prefectures" value="{{ old('prefectures') }}" required autocomplete="prefectures" autofocus >
                                    @foreach(config('prefectures') as $index => $name) 
                                        <option value="{{ $index }}">{{ $name }}</option>
                                    @endforeach
                                </select>
