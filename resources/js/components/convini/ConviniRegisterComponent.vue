    ...
    <div>
        <div class="c-form__group">
            ...
            <div class="c-form__item">
                <input id="convini_name" type="text"  name="convini_name" v-model="convini_name">
        ...
        <div class="c-form__group">
            <label>支店名</label>
            <div class="c-form__item">
                <input id="branch_name" type="text"  name="branch_name" v-model="branch_name">
        ...
        <div class="c-form__group">
            <label>都道府県</label>
            <div class="c-form__item">
                <select id="prefectures" type="text"  name="prefectures" v-model="prefecture">
        ...
        <div class="c-form__group">
            ...
            <div class="c-form__item">
                <input id="password_confirm" type="password"  name="password_confirm" v-model="password_confirm">
